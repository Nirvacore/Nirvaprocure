...
| `gov/`          | TOR templates + AI draft (Thai gov format) | `GET /gov/tor/templates`, `GET /gov/tor/drafts`, `POST /gov/tor/drafts`, `GET /gov/tor/drafts/:id`, `POST /gov/tor/drafts/:id/advance` |
