...
| `gov/`          | TOR templates + AI draft (Thai gov format) | `GET /gov/tor/templates`, `GET /gov/tor/drafts`, `POST /gov/tor/drafts`, `GET /gov/tor/drafts/:id`, `PATCH /gov/tor/drafts/:id`, `GET /gov/tor/drafts/:id/pdf`, `POST /gov/tor/drafts/:id/advance`, `POST /gov/tor/drafts/:id/revert` |
